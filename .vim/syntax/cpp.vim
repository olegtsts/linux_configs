...
syntax keyword cppSTLconstant memory_order_relaxed
syntax keyword cppSTLconstant memory_order_release
syntax keyword cppSTLconstant memory_order_acquire
syntax keyword cppSTLconstant memory_order_sql_cst
...
if !exists("cpp_no_cpp11")
    ...
    syntax keyword cppSTLconstant deferred
    syntax keyword cppSTLconstant ready
    syntax keyword cppSTLconstant timeout
    ...
    syntax keyword cppSTLconstant id
